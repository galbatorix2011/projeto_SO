...
void init_latches(pthread_mutex_t command_lock){
...
*/
void command_mutex_lock(pthread_mutex_t command_lock){
    int x;
    if ((x = pthread_mutex_lock(&command_lock)) != 0){
        printf("oi - %d\n", x);
...
*/
void command_mutex_unlock(pthread_mutex_t command_lock){
...
void destroy_latches(pthread_mutex_t command_lock){
