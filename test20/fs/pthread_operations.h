...
typedef enum func_type {F_WRITE, F_READ, F_MOV_DIF_FIRST_O, F_MOV_DIF_FIRST_D, F_MOV_DIF_SECOND_O,
    F_MOV_DIF_SECOND_D, F_MOV_SAME_FIRST_O, F_MOV_SAME_FIRST_D, F_MOV_SAME_SECOND_O, F_MOV_SAME_SECOND_D } func_type;
