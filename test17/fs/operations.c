...
void create_move_locks(locked_stack *stack, int size1, char* parent_name1, int size2, char* parent_name2, 
			int * parent_inumber1, int *parent_inumber2) {
	if (size1 != size2) {

		if (size1 < size2){
			*parent_inumber1 = lookup(parent_name1, stack, F_MOV_DIF_SIZE);
			*parent_inumber1 = lookup(parent_name2, stack, F_MOV_DIF_SIZE);
		}
		...
		*parent_inumber1 = lookup(parent_name1, stack, F_MOV_SAME_SIZE);
		*parent_inumber1 = lookup(parent_name2, stack, F_MOV_SAME_SIZE);
...
int move(char *path1, char* path2, locked_stack* stack) {
	...
	//int child_inumber1, child_inumber2;
	int size1, size2;
